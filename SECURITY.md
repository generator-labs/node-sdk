...
If you discover a security vulnerability within the Generator Labs Node.js SDK, please send an email to security@generatorlabs.com. All security vulnerabilities will be promptly addressed.
...
This SDK uses:
- **TypeScript strict mode** - Type safety and compile-time checks
- **CodeQL** - Automated security vulnerability scanning
- **Dependabot** - Automated dependency updates and vulnerability alerts
- **npm audit** - Security audits of dependencies

Run security checks locally:
```bash
npm audit                # Check for known vulnerabilities
npm run lint            # Run ESLint
npm run build           # TypeScript compilation checks
```
...
- axios instances maintain connection pooling for performance
